...
Following configuration is required to set up Elasticsearch. The Elasticsearch client configuration takes place via [OpenDXP Elasticsearch Client](https://github.com/open-dxp/elasticsearch-client-bundle) and has two parts:
...
For the further configuration of the client, please refer to the [OpenDXP Elasticsearch Client documentation](https://github.com/open-dxp/elasticsearch-client-bundle/blob/1.x/README.md).
