...
opendxp.registerNS("opendxp.bundle.advancedObjectSearch.searchConfig.conditionAbstractPanel");
opendxp.bundle.advancedObjectSearch.searchConfig.conditionAbstractPanel = Class.create({
