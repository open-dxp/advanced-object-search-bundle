...
opendxp.registerNS("opendxp.bundle.advancedObjectSearch.searchConfig.conditionEntryPanel");
opendxp.bundle.advancedObjectSearch.searchConfig.conditionEntryPanel = Class.create(opendxp.bundle.advancedObjectSearch.searchConfig.conditionAbstractPanel, {
                    ...
                    change: function( item, newValue, oldValue, eOpts ) {
                        ...
                        if(record) {
                            ...
                            if(opendxp.bundle.advancedObjectSearch.searchConfig.fieldConditionPanel[fieldSelectionInformation.fieldType]) {
                                this.fieldCondition = new opendxp.bundle.advancedObjectSearch.searchConfig.fieldConditionPanel[fieldSelectionInformation.fieldType](fieldSelectionInformation, data, this.classId);
