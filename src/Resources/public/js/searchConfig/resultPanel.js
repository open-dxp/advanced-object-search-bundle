...
opendxp.registerNS("opendxp.bundle.advancedObjectSearch.searchConfig.resultPanel");
opendxp.bundle.advancedObjectSearch.searchConfig.resultPanel = Class.create(opendxp.bundle.advancedObjectSearch.searchConfig.resultAbstractPanel, {
    ...
    initialize: function ($super, getSaveDataCallback, gridConfigData, portletMode) {
        ...
        if(!this.portletMode) {
            this.extensionBag = new opendxp.bundle.advancedObjectSearch.searchConfig.ResultPanelExtensionBag(this, typeof gridConfigData != 'undefined' ? gridConfigData.predefinedFilter : null);

            const advancedObjectSearchResult = new CustomEvent(opendxp.events.onAdvancedObjectSearchResult, {
                detail: {
    ...
    getLayout: function (initialFilter) {
        ...
        if (this.layout == null) {
            ...
            if(!this.portletMode) {
                ...
                this.layout.setIconCls('opendxp_bundle_advancedObjectSearch_grid');
    ...
    createGrid: function (fromConfig, response, settings, save) {
            ...
            items: [
                {
                    ...
                    handler: function (grid, rowIndex) {
                        ...
                        opendxp.helpers.openObject(data.id);
                    }.bind(this)
                }
            ]
        });
        ...
        this.languageInfo = new Ext.Toolbar.TextItem({
            text: t("grid_current_language") + ": " + opendxp.available_languages[this.gridLanguage]
        });
    ...
    openColumnConfig: function () {
        ...
        var dialog = new opendxp.object.helpers.gridConfigDialog(columnConfig, function (data) {
