...
opendxp.registerNS("opendxp.bundle.advancedObjectSearch.searchConfig.");
opendxp.bundle.advancedObjectSearch.searchConfig.ResultExtension = Class.create({
    initialize: function () {
...
opendxp.bundle.advancedObjectSearch.searchConfig.ResultPanelExtensionBag = Class.create({
