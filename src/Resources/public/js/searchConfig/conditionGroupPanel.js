...
opendxp.registerNS("opendxp.bundle.advancedObjectSearch.searchConfig.conditionGroupPanel");
opendxp.bundle.advancedObjectSearch.searchConfig.conditionGroupPanel = Class.create(opendxp.bundle.advancedObjectSearch.searchConfig.conditionAbstractPanel, {
    ...
    getInnerConditionPanel: function(myId, data) {
        var helper = new opendxp.bundle.advancedObjectSearch.searchConfig.conditionPanelContainerBuilder(this.classId, this, myId, this.conditionEntryPanelLayout);
