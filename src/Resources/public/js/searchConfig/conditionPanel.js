...
opendxp.registerNS("opendxp.bundle.advancedObjectSearch.searchConfig.conditionPanel");
opendxp.bundle.advancedObjectSearch.searchConfig.conditionPanel = Class.create({
    ...
    getConditionPanel: function() {
        var helper = new opendxp.bundle.advancedObjectSearch.searchConfig.conditionPanelContainerBuilder(this.classId, this, "root-panel", this.conditionEntryPanelLayout);
