...
opendxp.registerNS("opendxp.bundle.advancedObjectSearch.searchConfig.fieldConditionPanel.default");
opendxp.bundle.advancedObjectSearch.searchConfig.fieldConditionPanel.default = Class.create({
