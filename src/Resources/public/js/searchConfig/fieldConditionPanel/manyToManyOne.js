...
opendxp.registerNS("opendxp.bundle.advancedObjectSearch.searchConfig.fieldConditionPanel.manyToOneRelation");
opendxp.bundle.advancedObjectSearch.searchConfig.fieldConditionPanel.manyToOneRelation = Class.create(opendxp.bundle.advancedObjectSearch.searchConfig.fieldConditionPanel.default, {
                    ...
                    change: function( item, newValue, oldValue, eOpts ) {
                        ...
                        if(newValue != "object_filter") {
                                    ...
                                    listeners: {
                                        change: function( item, newValue, oldValue, eOpts ) {
                                            ...
                                            if(newValue != oldValue) {
                                                ...
                                                this.subConditions = new opendxp.bundle.advancedObjectSearch.searchConfig.conditionPanel(newValue, null, "auto");
                            ...
                            if(this.data.filterEntryData && this.data.filterEntryData.classId) {
                                this.subConditions = new opendxp.bundle.advancedObjectSearch.searchConfig.conditionPanel(this.data.filterEntryData.classId, this.data.filterEntryData, "auto");
                                this.subConditionsPanel.add(this.subConditions.getConditionPanel());
                            }
