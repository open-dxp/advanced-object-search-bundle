...
opendxp.registerNS("opendxp.bundle.advancedObjectSearch.searchConfig.fieldConditionPanel.quantityValue");
opendxp.bundle.advancedObjectSearch.searchConfig.fieldConditionPanel.quantityValue = Class.create(opendxp.bundle.advancedObjectSearch.searchConfig.fieldConditionPanel.numeric, {
    ...
    getConditionPanel: function() {
        ...
        opendxp.helpers.quantityValue.initUnitStore(this.setUnitStoreData.bind(this), this.fieldSelectionInformation.context.units);
