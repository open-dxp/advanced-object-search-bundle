...
opendxp.registerNS("opendxp.bundle.advancedObjectSearch.searchConfig.fieldConditionPanel.fieldcollections");
opendxp.bundle.advancedObjectSearch.searchConfig.fieldConditionPanel.fieldcollections = Class.create(opendxp.bundle.advancedObjectSearch.searchConfig.fieldConditionPanel.default, {
                ...
                listeners: {
                    change: function( item, newValue, oldValue, eOpts ) {
                        ...
                        if(record) {
                            ...
                            this.fieldConditionPanel.removeAll();
                            if(opendxp.bundle.advancedObjectSearch.searchConfig.fieldConditionPanel[fieldSelectionInformation.fieldType]) {
                                this.fieldCondition = new opendxp.bundle.advancedObjectSearch.searchConfig.fieldConditionPanel[fieldSelectionInformation.fieldType](fieldSelectionInformation, data);
