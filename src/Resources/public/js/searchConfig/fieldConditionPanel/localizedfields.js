...
opendxp.registerNS("opendxp.bundle.advancedObjectSearch.searchConfig.fieldConditionPanel.localizedfields");
opendxp.bundle.advancedObjectSearch.searchConfig.fieldConditionPanel.localizedfields = Class.create(opendxp.bundle.advancedObjectSearch.searchConfig.fieldConditionPanel.default, {
    ...
    getConditionPanel: function() {
        ...
        this.subPanel = new opendxp.bundle.advancedObjectSearch.searchConfig.fieldConditionPanel[this.fieldSelectionInformation.context.subType](this.fieldSelectionInformation, subData);
