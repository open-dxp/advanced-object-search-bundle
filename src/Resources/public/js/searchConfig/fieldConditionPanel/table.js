...
opendxp.registerNS("opendxp.bundle.advancedObjectSearch.searchConfig.fieldConditionPanel.table");
opendxp.bundle.advancedObjectSearch.searchConfig.fieldConditionPanel.table = Class.create({
