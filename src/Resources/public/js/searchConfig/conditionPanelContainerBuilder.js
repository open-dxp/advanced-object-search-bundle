...
opendxp.registerNS("opendxp.bundle.advancedObjectSearch.searchConfig.conditionPanelContainerBuilder");
opendxp.bundle.advancedObjectSearch.searchConfig.conditionPanelContainerBuilder = Class.create({
    ...
    addConditionEntryPanel: function(data) {
        var itemClass = new opendxp.bundle.advancedObjectSearch.searchConfig.conditionEntryPanel(this.classId, this.conditionEntryPanelLayout);
    ...
    addConditionGroupPanel: function(data) {
        var itemClass = new opendxp.bundle.advancedObjectSearch.searchConfig.conditionGroupPanel(this.classId, this.conditionEntryPanelLayout);
        var item = itemClass.getConditionPanel(this.parentPanel, data);
        this.conditionsContainerInner.add(item);
        item.updateLayout();
        this.conditionsContainerInner.updateLayout();
