...
opendxp.registerNS("opendxp.bundle.advancedObjectSearch.selector");
opendxp.bundle.advancedObjectSearch.selector = Class.create({
    ...
    moveToTab: function () {
        ...
        this.myTabId = "opendxp_search_" + uniqid();
    ...
    getPagingToolbar: function() {
        var pagingToolbar = opendxp.helpers.grid.buildDefaultPagingToolbar(this.store);
