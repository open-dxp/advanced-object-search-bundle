...
opendxp.registerNS("opendxp.layout.portlets.advancedObjectSearch");
opendxp.layout.portlets.advancedObjectSearch = Class.create(opendxp.layout.portlets.abstract, {

    getType: function () {
        return "opendxp.layout.portlets.advancedObjectSearch";
    },
    ...
    getIcon: function () {
        return "opendxp_bundle_advancedObjectSearch";
    },
        ...
        defaultConf.tools = [
            {
                type:'search',
                handler: function() {
                    opendxp.bundle.advancedObjectSearch.helper.openEsSearch(this.config);
                }.bind(this)
            },
            {
                type:'gear',
    ...
    editSettings: function () {
        var selector = new opendxp.bundle.advancedObjectSearch.selector(this.updateSettings.bind(this));
    },
        ...
        if(this.config) {
            Ext.Ajax.request({
                ...
                success: function (response) {
                    ...
                    var resultPanel = new opendxp.bundle.advancedObjectSearch.searchConfig.resultPanel(
                        function() {
